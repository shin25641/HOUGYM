...
<body class="wrapper-trainerList" style="background-color: #111111;">
	...
	<div class="content-trainerList">
		<div class="content-trainerList-top">
			<h1 class="h1-locker" style="font-family: dohyun;"> 트레이너 관리</h1>
			<hr class="hr-locker" align="left" >
		</div>
		<div class="content-trainerList-left">
			<%@ include file="../include/myPageSidemenu.jsp"%>
		</div>
		<div class="content-trainerList-middle">
			<div style="text-align: right;">
				<button type="button" class="btn btn-primary" style="background-color: #055ff7; border-color: blue;" onclick="location.href='trainerRegister'">트레이너 등록</button>
			</div>
						...
						<tr>
							...
							<tbody>
								...
								<tr>
										...
										<td><a href="#trainerInfoModal" data-toggle="modal"
								...
								<nav aria-label="Page navigation example">
								  <ul class="pagination" style="width: 100px; margin-left: auto;margin-right: auto;">
								    ...
								    <c:forEach begin="1" end="${pc.totEndPage }" step="1" var="cnt">
									    <li class="page-item"><a class="page-link" href="trainerList?start=${cnt }">${cnt }</a></li>
								    </c:forEach>
								    <c:choose>
